...
dev.off()
```
![Histogram of Steps Per Day](instructions_fig/Hist_01.png)
...
dev.off()
```
![Average Steps by Intervals](instructions_fig/Average_Intervals.png)
...
dev.off()
```
![Histogram of Corrected Frecuencies](instructions_fig/Hist_Corrected_Frecuencies_01.png)
...
![Difference in Patterns weekday-weekend](instructions_fig/Difference_in_Patterns_01.png)
